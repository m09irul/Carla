...
class World(object):
    def __init__(self, carla_world, hud, args):
        ...
        # Load your pre-trained YOLOv3 model
        ...
        # Set the process_image method to be called
        # whenever the camera sensor captures an image
...
#new start
    def process_image(self, image):
            ...
            img = torch.from_numpy(array.copy()).permute(2, 0, 1)
