...
def main():
    ...
    destination = carla.Location(x=spawn_point.location.x + 10, y=spawn_point.location.y+50, z=spawn_point.location.z)
    ...
    while not done:
        ...
        if waypoints:
            ...
            if len(turn_indexes) != 0:
                ...
                if turn_distance <= 30 and image_taken == False:
                    image_taken = True
                    take_picture(display)
